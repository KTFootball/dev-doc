...
```shell
curl "https://watchman.ktfootball.com/<SERVICE_NAME>/api/v1/recesses/<ID>"
```
### HTTP Request

  `GET https://watchman.ktfootball.com/<SERVICE_NAME>/api/v1/recesses/<ID>`
...
```json
{
    "data": {
        ...
        "actions": [
            {
                "image": "http://public.ktfootball.com/uploads/school_big_classroom_action/picture/28/_________.jpg",
                "name": "小步跑(左右交叉)"
            },
            {
                "image": "http://public.ktfootball.com/uploads/school_big_classroom_action/picture/29/____.jpg",
                "name": "脚底踩球"
            },
            {
                "image": "http://public.ktfootball.com/uploads/school_big_classroom_action/picture/30/_______.jpg",
                "name": "虚晃外跨,内跨"
            },
            {
                "image": "http://public.ktfootball.com/uploads/school_big_classroom_action/picture/31/________.jpg",
                "name": "双脚靠球(幼儿)"
            },
            {
                "image": "http://public.ktfootball.com/uploads/school_big_classroom_action/picture/32/_________.jpg",
                "name": "脚内侧传球(幼儿)"
            },
            {
                "image": "http://public.ktfootball.com/uploads/school_big_classroom_action/picture/33/____.jpg",
                "name": "蹲起跳跃"
            }
        ]
    }
